...
- voltage from divider and also 330R there for current/any bleed???
- amplify square (eg. 2.5 x 2.5=6.25 /10=0.625 *4 = 2.5) = 1x1 =1 = 8x???
- amp signum (reduce 56k?)
- amp on all multipliers so 5v is 1x = 8x then so 1k/7k // leave inner cell mults as is???
