offset. vca is multiplier so is not inserting signals...

- one slower mindlin controls another...

** 3/6/2022

- we will have to redo mindlin as we had all feedback on one 10k into first invertor
...
*TODO: solo mindlin with corrections, switched sprott/mindlin, extended mindlin/switched*
...
// whichever decision input on mindlin is dominating and out is too heavy/strong
