...
// how to fix hard hitting: retrial Mindlin with just multipliers then trial extensions...

or go back to dual filter notion: shared/normed clock

*** 13/10/2022

- fixed hardware problem below. but still too aggressive and hitting bounds...

- trial with 2k into each INTegrator... TODO

*** 11/10/2022

- output is still too high (20 Vpp from B3???), sometimes for all

is issue with last integrator???? U6 or U1 // fixed as ws power on q1 transistor - replaced
