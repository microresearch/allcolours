...
- start with Aurora Consurgens/rising dawn All Colours stuff (see notebook)
...
- panel finished but double check before ordering

* 10/10

- testing so far: we need to re-adjust /adj/ resistors on all comparators...


* TODO:

- programming test, basic hardware tests (eg. white noise, comparators, etc)...
- panel left will need full solder mask, right need all gold, circles, order panel

black on gold right side, circles for INPUTS! TODO!

match holes panel/pcb AGAIN!!!
