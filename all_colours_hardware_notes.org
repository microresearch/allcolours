...
- 7490 bandpass with noise source
- flip/flop touch
...
- ALL pulses/SR are in interrupts, all as multiple pulse outs without modes/cases for these, modes only for how SR connects...
