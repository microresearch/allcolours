...
- we need to change the 4932 comparator for a fast op amp with higher common mode input voltage, maybe also all op amps on 12v supply or?

* 21/10

- try replace 4932 with TLE2072 (mouser: 595-TLE2072IDR ) and see if bleedthrough
- no impedance issues on comp inputs
- TODO: recheck all comps and filter levels with scope, clicks were
  ...
  interrupts and pulse out, modes etc...
