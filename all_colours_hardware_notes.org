...
[not ein prevoosu version lower shouild be 20k and upper 10k?)
...
- *fix 	//13- electronotes: CV selects which bits to set to 1 = chance of change -> with lookup array -> TO TEST*
