...
so we need straight clock in without comp?

noise: 2x noise out for patchings

ouroboros: in and out

- what is size in HP (for standalone we could use 4ms pod as 26, 32 or 60 HP - also frap tools)= *32HP=162.5mm*
