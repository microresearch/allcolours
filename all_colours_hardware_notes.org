...
- we need to fix levels (high freq noise now with 100k in feedback gives 5 VPP), fix range of comparators for this - so each is say 4.7k top and bottom to give 2.5v-7.5v with centre at 5v
