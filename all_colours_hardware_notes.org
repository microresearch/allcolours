...
- *low pass on output in case pwm comes through*
...
- panel breakout for euro/less analogue version: replace pads, how many?, include voltages and in/out - interchangeable front panel
