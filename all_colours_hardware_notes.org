...
//DACS:
32-48 -CV and DAC -> interpol options (how many bits to wait if any, mode 32 is now only one with waiting) and different ranges in either case

49-57 -pulse and unweighted DAC - different ranges, 8, 16 or 32 bits, weighted DAC in some cases

58-63 -pulse and other DACS

- test HF mode 38 as DAc mode which has same speed trick as 0 - this could be as mode 32 now
