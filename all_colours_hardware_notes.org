...
- speedhh in that loop in generak could be slower at one end (loggy this). *generate and test this*

- but should DAC be loggy or straight?
...
- 4th PWM mode could use bith/pulseout as gate to change the PWM (CV->PWM) *To implement and test...*

or could be regular+dac out mode
