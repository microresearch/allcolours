...
- fixed pulse divider on mode 20 and 21 -  *do this also for low side when we check that*
- fixed lengthbith so makes sense now -   *do this also for low side when we check that*

- finish divide down on LF side and test all, interpol and spacings for LF side
