...
- for LF side let's keep a low DAC, maybe change this on HF side
...
- that there could also be a few DAC modes where we process the SR faster than the DAC (how to measure this slow down?)
