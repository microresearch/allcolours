...
- minimal bleedthrough with TLE2072 as U12 sub (rework on pcb an schematic)
...
[note if we want other pulse ins as interrupts these are on: PB6 and PB10 which are EXTI: 6 an EXTI: 10 I guess?
