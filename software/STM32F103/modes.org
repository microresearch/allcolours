...
9- SR swopovers// feedbacks - 

10 -or select as pulse out one mode eg mode 1 with pulses??? // or // double all modes for pulse out = 128 modes? - depends on resolution

11+// other possible mode would be noise taps for noise out at different speeds...
