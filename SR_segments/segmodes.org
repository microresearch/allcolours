...
// or mix and math adcs...

// new signal processors: sample_and_hold, what else?

*TODO: 4094 implemented: outs are each bit, CVs from groups of bits and the QS/serial out (see 4094) below..., clock edges*

*TODO: check masking modes, do masking modes*
...
speedfrom: clock/speedCV/DAC(which?)
