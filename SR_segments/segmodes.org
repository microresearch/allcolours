...
*basic model, test basic geogens inc. ported//classic SRs, ADC and DAC, arrange, layout of inner and outer - new pointer arch, tails, interpol/strobe etc, recursions/gaps/attach/detachments, final tests/tweaks*
...
*do we have say use other routes // eg. use route from R, from opposing? or use another binroute count/local count, depth as count SR as count etc TODO*

*what is myroute[]?*

// *types of binroute/which count for binroute...*

** 7/9/2022

- address DAC etc - so question here of new functions and where DAC is addressed

- different ways of addressing matrices eg. stack, copies of matrices of existing values (TODO) - bump through these - list thses
...
- DONE i thinkprobs as speed - more granular or do we do this already?* - TODO: add more prob modes in general - but there are many
