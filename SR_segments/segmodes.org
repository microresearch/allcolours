...
*TODO: other basic SR options, 2s complement for ADC, DAC - in progress with various modes*

what other encodings are there? zig-zag, one's complement...
...
*TODO: other bit encodings for negative in adcetc/modeN*
