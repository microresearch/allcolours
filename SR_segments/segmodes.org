...
- DAC as param for abstract ADC modes 22-31 checkDONE
...
- +fixed speed thing in macro.h a bit/back+ changed adc for each so can have multiple w
- added ADC choices in intmode: LintselADC_63
