...
speed/prob
40 - basic rungler with gapped route function
41 - dacspeed3 as fixed speedfunc
42 - draft speedmodes
43 - speedfunc select
...
/// what do we need to fit in CC? and where
...
- test all geoCC one by one// nearly
...
added SR_geo_inner_probdepthdepthSS ^^^^^ for matrixp
...
also we havenow  all as speed18 18 octaves?
