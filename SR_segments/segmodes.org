...
- check what we have as fixed route 2<<7 or 1<<7 in bit/route func arrays references... also ADC/geoN should have route in/no route in opts/probs as major

prob of adc in we have...
