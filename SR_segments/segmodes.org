...
- geoC and tests, globals, rest of geos filled, strobe and other functions, testing and playing

** 3/11/2022

TODO: test first set of 16 geoC functions when we have right size for arrays and *checked these*

- get arrays to right size in bitsn -> if necessary add from exp modes...DONE but we still need more abstract modes, not worried for geoC
