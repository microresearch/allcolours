...
TODO: see below/fix depths

- new function arrays in new bits, draft first 16 modes for each side and test these...
...
// TODO: DONEuse globflag where needed in geogen/exp_port - also *where do we set globflag*
