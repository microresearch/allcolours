...
- HOW to plan last works... what needs to be done clearly stated...
...
- check all functions for each N<L<C<R - see above and below for extras

- define all outer and inner modes
- details
