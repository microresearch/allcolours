...
- less routes in on NN, and RR: looking at in NN, esp strobes to check and matrixp which is all route in

- check we have decent range of functions on each side!?
