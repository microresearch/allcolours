...
summarize: TODO: draft all modes in draftdec but we need 14 modes for DAC (lose 1=mode9)  and 29 (lose 2=modes31and19) for ADC, fill in LR modes for these and test
