...
- v/oct issue: resolve 1v octave issue finally  // where we are at:  

logspeed[] is 15 octaves: slowest speed measured with speedtexst now is 1Hz -> 16Khz

*100k cv in, 22k feedback, 60k -10knob - check this! for modeC we have R65 as 66.5k, R71 as 22K* // see sheet

[why do we have as 66.5K and not 60k as earlier - 66.5/22k = 1/3rd for 10v to 3.3v full range]
[22k is for cv in 100/22 = 4.54 which is what we want. *1v source pls - 11/8* ]
