...
- different tails and how we select these... can also be fake
  ...
  of SRs at full speeds... as tail is new param, and a potential route
  in
...
*use in outer modes:  &gate[0].dac, &gate[1].dac, &gate[2].dac, &gate[3].dac, &CV[x], &CVL[x], &ADCin, &Gshift_[0], &Gshift_[1], &Gshift_[2], &Gshift_[3], &clksr_[x], &param[x], &Gshift_[8] // TAIL!*
