...
- for gappedfunction we need always both::
...
- *IN PROCESS: unreverse logspeedsDONE and invert all CV//DONE and CVL but then we need to go through and correct all functions for this - len etc, all*

- *test new runglers as we implement them*

- *test all CC before we fill in gaps // mode by mode again as we catalogue*
