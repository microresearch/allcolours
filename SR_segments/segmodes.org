...
- *maybe pass modded IN/depth to speedmodes rather than have spdfracs with dac... make examples - so ones which have no IN or IN is or could be LFSR__[w] // modularize*

- home/ cleaning up newbits: 

- *TEST:* changed order and some new ones first 16 of geoCC
...
*TODO: list succbits and also place in newbits if relevant:*

// succ. no depth: zsuccbits, zsuccbitsI, zsuccbits_noshiftnod, zsuccbitsI_noshiftnod
// succ. depth: zsuccbitspp, zsuccbitsprob, zsuccbits_noshift, zsuccbitsI_noshift, zsuccbits_noshiftd, zsuccbitsIpp, zsuccbitsI_noshiftd
...
//DONEneed tests of probfuctionsDONE
