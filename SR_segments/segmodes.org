...
- *globalls without depth (list) will need gapped inner fuction with prob...TODO* fixed inners - to *test*



TODO:
- new Triadex mode - depth//no types
- globals RR - which ones are fixed if not all... or gropups say of bumpers...
- matrixp ops

+NN: adc/abstracts, some cycles
