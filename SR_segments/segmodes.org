...
TODO: check bits_and_prob.org and other c and org files for modes/prob, what we have so far, how to maybe make more generic/new versions...

** 16/3/2022

*TODO: detach length of SR and bitdepth in modeN/adcetc...*
...
*TODO: we can have a pattern from otherSR or incoming of where/if bits come in*
...
*TODO: for adc-> 8 bit fixed modes (12bits and 4 we have), fixed equivalent bits in eg. 4 bits equiv...* 
...
- do we already have double length 0-63 SRs - *TEST NLdoublelength*
...
- *TEST*: NLCVDACroute if CV>DAC - entry of new bit from [ADC, route or cycle] XOR cycle/route etc... - use what for this choice of route - detached - but does as adc or...
N87_4bits_strobein
Nint72dacmix - using dac for mix
...
*TODO: list of dacmode in modeN.h// uint8_t dacmodes[16]= { // outs which use DAC*

** 22/2/2022

- get back into code and TEST new adc mode 86: cut feedback - eg. cut for CV count clk pulses/on off
// detached mode -> *NLcutfeedback86*
