...
- divide into speedCV, trigger/pulse - so that makes 32 modes doubled up

maybe with/without coggs as further option becomes 16 modes

/// LOTS TO RESOLVE:

*questions to resolve: routing and feedback, coggs or micro-registers, in or out number of bits vs. length of register* 
...
- also question as bitc is out but speed there determines speed of
...
NSR->LSR->CSR
   ->RSR->NSR [in this routing then how do we make sense of NSR length]
...
- isolate generic structure and re-do for pointer arrays...
- in progress in test2.c
