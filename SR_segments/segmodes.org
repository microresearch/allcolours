...
generic vienna model: redo with interpoll (also if this is for major/minor modes how does RSR fit with reduced bits of course?, then RSR is more like tail)

abstractions: list these? but still have param shortage...

expanded rungler model with different options and switched routings TODO

mishmash here: bitmodes, probmodes, recursions, esoteric modes
minor/major modes,
...
*sliding of matched functions - so there is major one and others deviate from that by wrapped value... versions of this*
...
*logspeedd for no stops eg. in all modeC*

** TODO

make new dir/files

*modes which manipulate other SRs ???*
...
*- new abstraction to fill in/// how we could translate geomantic figures and/or minor_vienna to that scheme?*

// major work is on porting functions... and in work on tails...
...
*leave and don;t reset counts and routemask/binary // do we want masks for other counts - new model eg. we have tmp=binroute[count][w]|binary*
