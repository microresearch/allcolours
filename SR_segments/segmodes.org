...
*how to test that we do resetc/all*
...
- *re-test all routefuncs // all speedfuncs // all probfunctions (well still to test these). and check logic by hand*
