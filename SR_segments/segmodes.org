...
- test/play
- tweaks for speed, CLK norms, what else? how we handle one bit audio filter?
...
- other ways of thinking of modes... (mode as itself shift_register, pulses as incrementing modes or is that all too complicated)
...
- ports from AC, ports from first tests it.c
