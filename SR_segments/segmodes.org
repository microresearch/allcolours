...
*re-check strobey, pulsins, pulsouts for all modeX.h modes and count=0 where necessary in modeR.h*
...
*where do we change dacmode for NLR?*

*can also have XOR opps for routing tables, where do we get dac/sr from - how to change this, mixes of DACs, all recursions*
