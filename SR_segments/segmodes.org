...
- new geoC.h to start to sketch modes// differences between new_geo and others...

** 7/10/2022

- lowest modes set adc/dactype/dacpar  - plan how we deal with holes and matrices: Modes should decide whether to make use of matric or not!
...
// how to make global for NLR dacs... - that we have tables of dactypes or... but that would be very long 5 bits for each - or global inc of dactype - TEST! as they can be out of sync

adc we have functions for - juts need to pull out     if (w==0){ // real ADC - TESTY - how we will handle adc across all

////

question of updates in new_geomantic??? define types of inner and outer?
