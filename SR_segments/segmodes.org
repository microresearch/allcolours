...
*TODO: below, can add/test new speeds/bursts (also for xorspeeds for NN, LL and RR), can add prob of adc entry array for NN (below), shift all strobe funcs to end of arrays*
...
- quick lower test - issues with globals and *we need to check depth in all function arrays*
