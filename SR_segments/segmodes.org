...
*TODO: longer order arrays to downsample*
...
// *dacspeed3 or 4 as preferable // 3x 4x too with speedfrom, also c41 speed type selection*

*for NN which ones do or dont use ADC- how to divide*

*also sort better strobe and nonstrobe order in functions*

//// what is difference osc1bits and osceq? they are the same... so now we fix osceq to use IN for second bit - can also be reversed ones/zeros
...
--> *how do we reset matrix/matrixp to something sensible if say is all attached, by filling gaps - settle down//reset at end*
