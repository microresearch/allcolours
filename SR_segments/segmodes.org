...
- *now back to idea of more mobile strobe with fill in CV as prob - see SR_geomantic_outer_test*
- probs as speed - more granular or do we do this already
...
- generic outer wrapper with inline inners/macros - trial this
...
fill out all speeds/functions but shouldnt access beyond what we have but still eg. speedfromstrobe is fixed by outer
