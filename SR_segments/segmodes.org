...
*5th tail always running and how we switch in to it differenmt streams from SRs*

** 5/5/2022

- slower speeds to test without stoppings
...
// but how many streams run simultaneously
