...
- maximum 12 bits 
- padded any number of bits
- fixed number of bits: 12,8,4
- one bit encoding
- equivalent bits
- energy equivalent bits (abs value)
- fixed 12 bits 2s complement: can also be 8,4
- variable depth 2s comp
- fixed 12 bits 1s complement: can also be 8,4
- variable depth 1s comp

- comparator is an encoding????
