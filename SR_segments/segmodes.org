...
- test with/withouts coggs running - how this works
...
[so that gives us 8 or so modes for each one]
...
- multiple flipflops of various decsriptions for pulses out
...
- *look at AC SRs and see what can be adapted for LSR as incoming bits and cycling bit (or combinations of these)*
