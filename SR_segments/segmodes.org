...
- test gapped strobe function. *SR_geo_inner_str_function* TEST!
- test spdfracdac3 and new version// *spdfracdac3/4* > *SR_geo_outer_dacspeed*
- test spdvienna2, 3, 4 in new speeds
- zcountbitsI added TEST
- test prob tryout // test diverse prob functions... probf_anystrobe_depth[64]: SR_geo_outer_probfunc
- test strobe (no depth) xor with speedmodes (just strobe or strobe_modes, spdfrac or speedmodes) - but how we select each... fixed sel *SR_geo_outer_strobexor*
...
- speedmodes can have dac as depth (or cv plus dac etc) - speedfromnostrobe_noIN // calc is in outer but new func in inner... *SR_geo_outer_dacasdepthspeed*
...
- DONE/TEST-pull out: spdfracdac3 as special speed case with CV and CVL - retest and rework for +-
...
- *different versions spdvienna todo - done to test spdvienna2, 3, 4 in new speeds*
