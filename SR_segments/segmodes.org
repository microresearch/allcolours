...
add in DACs into ADC and DAC modes:

//for input modes
CV+DAC as input
CV+DAC as comparator for input
CV+DAC as input spacings

CV+DAC as output spacings
...
CV selects routing in INT modes
CV+DAC selects routing in INT modes
...
- idea that CLK pulsins could trigger train of x pulses at speed y
  ...
  from other SR - how to do this?TRIAL?
