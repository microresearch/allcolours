...
*alternating routes* eg. route in can be 4 bits from one SR (shifting)// hold from GSR and shift on strobe

list types of binroute: 

1no binroute/2binroute_/3binroutesr_/4justcycle/5binroutealt/6zeroes 
...
but what are types of gshift: no gshift, gshift and no <<sr, gshiftcopy only on strobe...
