...
*only RESET on change in first mode*
...
*need somehow right mode which keeps own function and just resets - so is all gapped - or can globals on right be all gapped*
