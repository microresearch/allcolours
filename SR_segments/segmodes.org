...
- HEAD macro should be fixed but check this...
...
*TODO: ADC_for_our_speed - top bits//rest bits as speed/mod for DAC?*
...
1 bit audio is still odd - and length does nothing here *again length issue in adc and adc*
