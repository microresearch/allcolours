...
- DONE/test: *seperate matrix for abstract ops* - replace what was route with 18 and maybe *take care of all theroute and globflags already...*
...
*clean up all succbits: why does succbits have: gate[x].Gshift_[0] and not share or gate[x].Gshift_[w] ???* - replace with share // also better define differences
