...
- Notes and new tests from notebook on tests with first 32 modes: simplify all...

- first 16 modes are less modular and more fixed. less/no gaps.
...
- some NZbinroutfixed_prob1x are the same as wiard bits - prob of route/route inv vs cycle/cycle inv...
