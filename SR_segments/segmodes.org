...
MAJOR question is how we can constrain param as INTcounter to be 12 bits - *we need to get an idea of range of param as we treat as 12bits?*

  // crash detect ++ 32/64 in main.c is 14KHz //and/or speed check... we have 32 16 which is 4x14=56KHz

so TIM2 loop is 56000 per second - one second is 56000 count to check
1khz is 56
