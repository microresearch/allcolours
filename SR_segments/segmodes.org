...
26: as 25 but with DAC as source - added logic tabl
...
- possible multiple adcs in modes,,,, 

- added case 30: adc | xor TODO with lenght of bits, for INTmode this can also be CV-param

*otherpar can also be CV for intmodes*

- expanded ADC_ function for extra params but should decide on how many bits for otherparam (dac is 12 bits so) and then fix length/restrictions there
