...
- finish ports from geomantic to geoC, binroute area, start to fill geoC , all modes at 64 or 32 and adjust accordingly and fix binsd array accesses
- matrixp area, geoC and tests, globals, rest of geos filled, strobe and other functions, testing and playing
