...
- tests on runglers - spdfrac3 or spdfrac4
- sanity check all: especially probabilities
- sanity check all code, line by line: 
- look at all probs and analysis below
...
- *do we need more abstract cases for w==3 in RR???, and no route in or prob of route in - where to place?*
