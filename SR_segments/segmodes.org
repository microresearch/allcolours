...
newmodes I think are in modeL - and need to be ported across!
...
*new org page for each mode - can also be towards manual*
...
idea from notebook, any below, probability of feedbackDAC/route in
...
RSR: feedback/probability

5th head/TAIL: conjoint of all other SR at full speed? or speed of entry?
...
*TODO: sliding x bit entry a la 97!*
...
-DONE/TODO: modeL/R where we don't ad dback in bitrr in gshift so just
...
[but do we really need?] for modeN idea of generators which keep track
 ...
 - sample depth independent of length is important (*TODO*)
...
*TODO: list of dacmode in modeN.h// uint8_t dacmodes[16]= { // which use DAC*
