...
Caput draconis (CD) is the latest ourorack ... companion

to have done with the judgement of god

successive dislocations 
...
how to image/notate panel - that the description and panel/images are themselves subjected to shift reg (eg. each piksel line of panel image - try this!)
