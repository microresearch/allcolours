...
uint32_t masky[32]={//0,0,0, // we don't use but here they are
			   0b00000000000000000000000000000000,			  
			   0b00000000000000000000000000000001,
			   0b00000000000000000000000000000011, // was missing			  
			   ...
			   //			   0b11111111111111111111111111111111,			    // only all 0s or all 1ss
};
...
static uint32_t othermasky[32]={  // skip all zeroes or all ones ???
  ...
  0b11111111111111111111111111111110 // we don't ever need all ones... or do we
};

#include <stdio.h>
int main() {
  int x, srlength=17, sh, shifter=4, tmpt, SRlengthn=8, sl=4, bitn=1;
  uint32_t shift_registern=0b00000000000000000000000011110000;
