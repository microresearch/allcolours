...
uint32_t (*routebitsnostrobenod[32])(uint32_t depth, uint32_t in, uint32_t wh)={binroutfixed, zjustcycle, binroutorgap, zsuccbits, zsuccbitsI, tailbits, zjusttail, tailbitsnos, tailbitsI, tailbitsInos, binroutesel0, binroutfixedmy, binroutfixedmyreset, binroutmybumpbit, binroutmybumpbitt, pbitSRroutelog, pbitSRroutelogxx, pbitSRroutelogxxx, pbitLSRroutexxxlog, pSR32, pSRmod, pSRN62, pSRN22, pSRN21, pSRNwas15, pSRRaccelghosts0, pSRR32, pSRaddroutes, pSRxorroutes, pSRshroute, pSRsigma, binroutfixed};
...
uint32_t (*routebitsfortypesnodepth[7])(uint32_t depth, uint32_t in, uint32_t wh)={binroutesel2, binroutesel3, Zzsuccbits, ZzsuccbitsI, NZzbinrouteINVbits, NZzbinroutebitscycle, NZflipflopandroute};
...
// compile list of routebitsfortypes which can be passed depth as route
...
uint32_t (*bitfromsdR[32])(uint32_t depth, uint32_t in, uint32_t wh)={binrout, binroutI, binroutfixed, binroutor, binroutAND0, zjustcycle, binroutfixed_prob1, zsingleroutebits, zbinrouteINVbits, zbinroutebits_noshift_transit, zbinroutebits_noshift, zbinroutebitscycle, zbinroutebitscyclestr, zbinroutebitscycle_noshift, zbinroutebitscyclestr_noshift, zbinrouteORbits, zbinrouteANDbits, zbinrouteSRbits, zbinroutebitsI_noshift, zbinroutebitscycleI_noshift, zbinroutebitscyclestrI, zosc1bits, sigmadelta, cipher, osceq, zprobbits, zonebits, zSRNbits, zSRLbits, zSRCbits, zSRRbits, selectglob};
