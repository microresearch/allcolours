...
int main(void)
{
  ...
  */    
  ...
  TIM_TimeBase_InitStructure.TIM_Prescaler = 32; // was 8//16 before// but check it what speed is this 18khz toggle = 36k  - how we can check - with one of our pins as out // was 21 (now 32 for latest geomantic code
  // 21 above is for 1Hz lowest speed 
