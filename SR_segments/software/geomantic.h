...
uint32_t *CVlist[4][22]={
  {&nulll, &gate[0].dac, &gate[1].dac, &gate[2].dac, &gate[3].dac, &CV[0], &CVL[0], &CVM[0], &ADCin, &Gshift_[0], &Gshift_[1], &Gshift_[2], &Gshift_[3], &clksr_[0], &param[0], &gate[0].par, &gate[1].par, &gate[2].par, &gate[3].par, &gate[0].oldcv, &gate[0].oldcvl, &gate[0].oldcvm},
  {&nulll, &gate[0].dac, &gate[1].dac, &gate[2].dac, &gate[3].dac, &CV[1], &CVL[1], &CVM[1], &ADCin, &Gshift_[0], &Gshift_[1], &Gshift_[2], &Gshift_[3], &clksr_[1], &param[1], &gate[0].par, &gate[1].par, &gate[2].par, &gate[3].par, &gate[1].oldcv, &gate[1].oldcvl, &gate[1].oldcvm},
  {&nulll, &gate[0].dac, &gate[1].dac, &gate[2].dac, &gate[3].dac, &CV[2], &CVL[2], &CVM[2], &ADCin, &Gshift_[0], &Gshift_[1], &Gshift_[2], &Gshift_[3], &clksr_[2], &param[2], &gate[0].par, &gate[1].par, &gate[2].par, &gate[3].par, &gate[2].oldcv, &gate[2].oldcvl, &gate[2].oldcvm},
  {&nulll, &gate[0].dac, &gate[1].dac, &gate[2].dac, &gate[3].dac, &CV[3], &CVL[3], &CVM[3], &ADCin, &Gshift_[0], &Gshift_[1], &Gshift_[2], &Gshift_[3], &clksr_[3], &param[3], &gate[0].par, &gate[1].par, &gate[2].par, &gate[3].par, &gate[3].oldcv, &gate[3].oldcvl, &gate[3].oldcvm}
