...
uint32_t (*routebits_nodepth_typesz[64])(uint32_t depth, uint32_t in, uint32_t wh)={Zbinrout, Zbinrouteforalt, Zbinrouteforaltalt, ZzbinrouteINVbits, Zzbinroutebitscycle, Zflipflopandroute, ZpSRsigma, Zzsuccbits, ZzsuccbitsI, pSR_recbin, pSRGswop, pSR_routeSRbits02, pSR_routeSRbits01, /**/Zbinrout, Zbinrouteforalt, Zbinrouteforaltalt, ZzbinrouteINVbits, Zzbinroutebitscycle, Zflipflopandroute, ZpSRsigma, Zzsuccbits, ZzsuccbitsI, pSR_recbin, pSRGswop, pSR_routeSRbits02, pSR_routeSRbits01, /*str*/ZzbinroutebitscyclestrI, zbinroutmybumpSalt, pSRxorroutes, pSRaddroutes, pSRDACroutestrobe, pSRN40, pSRN36, pSRN33cipher, pSRN33, pprobtoggle1, pprobtoggle2, pprobtoggle3, pprobtoggle4, pprobtoggle5, pprobstrobe1, pprobstrobe2, pprobstrobe3, pSRN8, pSRN7, pSRN6, pSRN5, pSRbumprouteD_, pSRLLswopD_, ZzbinroutebitscyclestrI, zbinroutmybumpSalt, pSRxorroutes, pSRaddroutes, pSRDACroutestrobe, pSRN40, pSRN36, pSRN33cipher, pSRN33, pprobtoggle1, pprobtoggle2, ZzbinroutebitscyclestrI, zbinroutmybumpSalt, pSRxorroutes, pSRaddroutes}; 
...
uint32_t (*routebits_anystrobe_depth_notypesz[32])(uint32_t depth, uint32_t in, uint32_t wh)={zsuccbitsprobd, zsuccbitspp, zsuccbits_noshift, zsuccbitsI_noshift, zsuccbitsIppd, zsuccbitsppd, zsuccbitsprobd, zsuccbits_noshiftd, zsuccbitsI_noshiftd, zsuccbitsIppd, zpattern4bits, zpattern8bits, zpattern4bitsI, zpattern8bitsI, zbinrouteSRbits, pSR_altbin1, pbitLSRroutexxxlog, pSRLcvSRmaskroute, pSRLcvroute, pSRNwas15, pSR_layer1, pSR_layer2, pSR_reflect, triadexbits, binrout_probXY2, binrout_probXY3, Zcyclesplit, zTMsimplebitsL, zTMsimplebits, pSRN30, pSRprobxortogx, zsuccbitsprobd};//32
