...
uint32_t (*routebits_nostrobe_nodepth_typesz[16])(uint32_t depth, uint32_t in, uint32_t wh)={Zbinrout, Zbinrouteforalt, Zbinrouteforaltalt, ZzbinrouteINVbits, Zzbinroutebitscycle, Zflipflopandroute, zbinroutmybumpbitalt, zbinroutmybumpbittalt, pSRshare, pSR_routeSRbits02, pSR_routeSRbits01, pSRRaccelghosts0, pSR_recbin, /*8*/Zbinrout, ZzbinrouteINVbits, Zzbinroutebitscycle}; 
...
// merges
uint32_t (*routebits_nostrobe_typesz[64])(uint32_t depth, uint32_t in, uint32_t wh)={Zbinrout_strip, Zbinroutor, ZbinroutsplitxorXX, Zbinroutsplit, Zbinroutsplitprob, Zbinroutsplitprob1, Zbinroutsplitprob2, Zbinroutsplitxor, Zviennabits, Zzsuccbitspp, ZzsuccbitsIpp, Zbinroutfixed_prob1, Zbinroutfixed_prob2, Zbinroutfixed_prob3, Zbinroutfixed_prob4, Zbinroutfixed_prob5, Zbinrout_probXY, Zbinrout_probXY1, NZbinrout_probXY, NZbinrout_probXY1, NZbinroutfixed_prob1, NZbinroutfixed_prob2, NZbinroutfixed_prob3, NZbinroutfixed_prob4, zbinroutmycvalt, zbinroutorgap, pSRmatch, pbitLcvsrroute, pstream, pSRN15, pSRxorSR, pSR_recbin, /*x*/Zbinrout, Zbinrouteforalt, Zbinrouteforaltalt, ZzbinrouteINVbits, Zzbinroutebitscycle, Zflipflopandroute, zbinroutmybumpbitalt, zbinroutmybumpbittalt, pSRshare, pSR_routeSRbits02, pSR_routeSRbits01, pSRRaccelghosts0, pSR_recbin, /*8*/Zbinrout, ZzbinrouteINVbits, Zzbinroutebitscycle, Zbinrout, Zbinrouteforalt, Zbinrouteforaltalt, ZzbinrouteINVbits, Zzbinroutebitscycle, Zflipflopandroute, zbinroutmybumpbitalt, zbinroutmybumpbittalt, pSRshare, pSR_routeSRbits02, pSR_routeSRbits01, pSRRaccelghosts0, pSR_recbin, /*8*/Zbinrout, ZzbinrouteINVbits, Zzbinroutebitscycle}; 
...
uint32_t (*routebits_nostrobe_nodepth[32])(uint32_t depth, uint32_t in, uint32_t wh)={Zbinrout, Zbinrouteforalt, Zbinrouteforaltalt, ZzbinrouteINVbits, Zzbinroutebitscycle, Zflipflopandroute, zbinroutmybumpbitalt, zbinroutmybumpbittalt, pSRshare, pSR_routeSRbits02, pSR_routeSRbits01, pSRRaccelghosts0, pSR_recbin, /*8*/Zbinrout, ZzbinrouteINVbits, Zzbinroutebitscycle, zbinroutebitsI_noshift, zbinroutebitscycleI_noshift, zbinrouteORbits, tailbits, tailbitsnos, binroutAND0, binroutAND00, pbitSRroutelogD_, pbitSRroutelogxxD_, pSR32D_, pSRN62, pSRN22D_, pSRN21D_, pbitSRroutelogxxD_, Zlast, zjustcycle};
