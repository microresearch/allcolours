...
Meli: //touch toggle a bit jumpy // test the rest!
...
- older modes such as always loop/overlay to check out
...
// does it make sense for rec... sort of...?
...
*TODO_TEST: MODE 79:local mode with different lengths but can repeat to full length with different overlays...*
...
*MODEX: tap freeze top in rec+play/overlay: record speed seperate and leave voltage free running (q of speed overlays or not), same for freeze on locals in another mode...*
