...
- question of freeze in overlay:

// *what FREEZE (call it TOGGLE maybe) can do in overlaid in each case, rather than freeze values??? or keep freeze in first 2 modes*
...
- algo as pulse in to freezers/toggles, minimode
...
circular stack of gestures - how to add, remove???
