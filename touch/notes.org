...
DONE6- as 5 but we keep original length// both can have that toggle
...
- change rec/play speeds - but in a volatile way...??? how we realise that - as we can't sense it in rec and in overlay it all feedsback!
...
- still could do thing where we start to repeat say first section (or a define island) and overlay this... 

or we can move fragmented areas to overlays... islands in overlays
...
- alternate feedback outs in overlay modes
