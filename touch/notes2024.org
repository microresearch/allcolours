...
Nada: add global from top, invert voltage, ghosts and mirrors - but does these stick around?
Rec:
Play:
RP:
...
TODO: somehow we lost pointer/speedref code: TO TEST: DONE	    // minormode speed as a pointer now
