...
- TODO: major/minor reset
- full test of first basic mode and all options

///

- *RP options*: overwrite/add playback/bounce onto tape x until we hit rec_end (of which tape) or we over_run:

- check overlay options below and refine:

// overwrite it with playback+real/overlay
// add real only to recordings
