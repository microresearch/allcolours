...
Each state has its own minormode but majormodes apply to all states for each position...
...
BUG where we don't rec or play// stays in NADA - or could just be that we record NADA!
