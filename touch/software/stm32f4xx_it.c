...
- test all modes and resolve questions of freezers (after playback), level of voltages/ADC, freezing of speed?
...
- [voltage controlled speed of all playback from top voltage ????what does this mean?]
